...
# Importuj widoki i kontrolery, aby je połączyć
...
class ViewController:
    ...
    def switch_to(self, view_class: Type[ttk.Frame], **kwargs: Any):
        ...
        # Zawsze twórz nowy widok, aby uniknąć problemów ze stanem
        # (można to zoptymalizować do cachowania w razie potrzeby)
